...
<section id="project_section">
	...
	<form name="project_work_form" id="project_work_form" action="<%= request.getContextPath()%>/project/work/update.do" method="post">
...
<script type="text/javascript">
	...
	$("#project_work_title_input_text").trigger("input");
	$("#project_work_content_input_textarea").trigger("input");
	$(".project_work_read_content_state").eq(${work.pw_status} - 1).trigger("click");
