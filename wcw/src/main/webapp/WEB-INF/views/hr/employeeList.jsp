...
<section id="section">
    ...
    <div id="modal">
        <div id="modal_section">
            ...
            <span class="modal_content">사원명 출력</span>
            ...
            <span class="modal_content">이메일 출력</span>
            <span class="modal_title">개인 연락처</span>
            <span class="modal_content">개인 연락처 출력</span>
            ...
            <input type="text" id="modal_text_intl">
            <span class="modal_title">퇴사 현황</span>
