...
CREATE TABLE TB_COMPANY (
	...
	CP_APPR_YN	        VARCHAR2(1) 	DEFAULT 'R'	    NOT NULL,
	CP_PWD	            VARCHAR2(256)		            NOT NULL
);

COMMENT ON COLUMN TB_COMPANY.CP_APPR_YN IS '승인: Y / 대기: R / 반려: N';
...
CREATE TABLE TB_DRAFT (
	...
	DR_EXPECT_DATE	    VARCHAR2(1000)		            NULL,
	DR_AMOUNT	        VARCHAR2(100)		            NULL
);
...
CREATE TABLE TB_PROJECT_FILE (
	...
	PF_DATE	DATE	DEFAULT SYSDATE	NOT NULL,
	PB_NO	NUMBER		            NULL,
    PN_NO   NUMBER                  NULL,
...
CREATE TABLE TB_VACATION (
	...
	VACA_APPROVER	    NUMBER		            NULL,
    VACA_ALLDAY         VARCHAR2(1)             NOT NULL,
    VACA_DENIED_TXT     VARCHAR2(300)		    NULL
);
...
CREATE TABLE TB_SPEND (
	DR_NO	            NUMBER		        NOT NULL,
	SPEND_DATE	        VARCHAR2(1000)		        NOT NULL,
	SPEND_PURPOSE	    VARCHAR2(1000)		NULL,
	SPEND_CONTENT	    VARCHAR2(1000)		NULL,
	SPEND_AMOUNT	    NUMBER		        NULL,
	SPEND_CONTENT_PRVT	VARCHAR2(1000)		NULL,
	SPEND_AMOUNT_PRVT	NUMBER		        NULL,
...
ALTER TABLE TB_PROJECT_FILE ADD CONSTRAINT FK_FIEL_TO_BOARD FOREIGN KEY (
	PB_NO
)
REFERENCES TB_PROJECT_BOARD (
	PB_NO
...
ALTER TABLE TB_PROJECT_FILE ADD CONSTRAINT FK_FIEL_TO_NOTICE FOREIGN KEY (
	PN_NO
)
REFERENCES TB_PROJECT_NOTICE (
	PN_NO
) ON DELETE CASCADE ;

ALTER TABLE TB_PROJECT_WORK_PARTICIPANT ADD CONSTRAINT FK_PARTICIPANT_TO_WORK FOREIGN KEY (
    PW_NO
)
REFERENCES TB_PROJECT_WORK (
    PW_NO
) ON DELETE CASCADE;

ALTER TABLE TB_PROJECT_BOARD ADD CONSTRAINT FK_PROJECT_TO_BOARD FOREIGN KEY (
    PR_NO
)
REFERENCES TB_PROJECT (
    PR_NO
...
ALTER TABLE TB_PROJECT_FILE_FOLDER ADD CONSTRAINT FK_PROJECT_TO_FOLDER FOREIGN KEY (
    PR_NO
)
REFERENCES TB_PROJECT (
    PR_NO
...
ALTER TABLE TB_PROJECT_TODO ADD CONSTRAINT FK_PROJECT_TO_TODO FOREIGN KEY (
    PR_NO
)
REFERENCES TB_PROJECT (
    PR_NO
...
ALTER TABLE TB_PROJECT_COMMENT ADD CONSTRAINT FK_COMMENT_TO_NOTICE FOREIGN KEY (
    PN_NO
)
REFERENCES TB_PROJECT_NOTICE (
    PN_NO
...
ALTER TABLE TB_PROJECT_COMMENT ADD CONSTRAINT FK_COMMENT_TO_BOARD FOREIGN KEY (
    PB_NO
)
REFERENCES TB_PROJECT_BOARD (
    PB_NO
...
ALTER TABLE TB_PROJECT_COMMENT ADD CONSTRAINT FK_COMMENT_TO_WORK FOREIGN KEY (
    PW_NO
)
REFERENCES TB_PROJECT_WORK (
    PW_NO
...
ALTER TABLE TB_TODO ADD CONSTRAINT FK_EMP_TO_TODO FOREIGN KEY (
    EMP_NO
)
REFERENCES TB_EMPLOYEE (
    EMP_NO
