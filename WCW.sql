...
DROP TABLE TB_ANUUAL_LEAVE CASCADE CONSTRAINTS;
...
CREATE TABLE TB_PROJECT_BOARD (
	...
	PB_CONTENT	VARCHAR2(1000)		    NOT NULL,
	EMP_NO	    NUMBER		            NOT NULL,
...
CREATE TABLE TB_PROJECT_WORK (
	...
	PW_CONTENT	    VARCHAR2(1000)		NOT NULL,
...
CREATE TABLE TB_ATTENDANCE (
	...
	ATT_CLOCK_IN	DATE    DEFAULT SYSDATE     NOT NULL,
	ATT_CLOCK_OUT	DATE	DEFAULT SYSDATE     NULL,
	IP_CLOCK_IN	    VARCHAR2(20)		        NOT NULL,
	IP_CLOCK_OUT	VARCHAR2(20)		        NULL,
	ATT_MODIFY_DATE	DATE	DEFAULT SYSDATE	    NULL,
	ATT_DELETE_YN	VARCHAR2(1)		            NULL
);


CREATE TABLE TB_VACATION (
	VACA_NO	            NUMBER		            NOT NULL,
	EMP_NO	            NUMBER		            NOT NULL,
	...
	VACA_REGISTER_DATE	DATE	DEFAULT SYSDATE	NOT NULL,
...
CREATE TABLE TB_ANUUAL_LEAVE (
	AL_NO	            NUMBER		NOT NULL,
	EMP_NO	            NUMBER		NOT NULL,
	AL_YEAR	            NUMBER		NOT NULL,
	AL_COUNT	        NUMBER		NOT NULL,
	AL_USE_DAYS	        NUMBER		NOT NULL,
	AL_REGISTER_DATE	DATE		NOT NULL
);
...
CREATE TABLE TB_PROJECT_NOTICE (
	...
	PN_CONTENT	VARCHAR2(1000)		    NOT NULL,
...
CREATE TABLE TB_ATTENDANCE_APPROVAL (
	ATT_APPR_NO	        VARCHAR(255)		NOT NULL,
	ATT_NO	            NUMBER		        NOT NULL,
	EMP_NO	            NUMBER		        NULL,
	ATT_APPR_CONTENT	VARCHAR2(300)		NOT NULL,
	ATT_APPR_TYPE	    VARCHAR2(1)		    NOT NULL,
	ATT_APPR_CLOCK_IN	DATE		        NOT NULL,
	ATT_APPR_CLOCK_OUT	DATE		        NOT NULL
);
...
ALTER TABLE TB_ANUUAL_LEAVE ADD CONSTRAINT PK_TB_ANUUAL_LEAVE PRIMARY KEY (
	AL_NO
);
